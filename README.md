...
=======
## 📱 Aplicativo de Monitoramento de Pacientes via Bluetooth

---

### 👨‍🔬 Inventores Fundadores

- **Correspondente do Produto:** Edward Moreno – [edmoreno@academico.ufs.br]
...
OBS: O backend foi desenvolvido em PHP apenas para fins de teste e validação inicial. No entanto, poderá ser substituído futuramente por outra API construída com tecnologias diferentes, conforme a evolução do projeto e suas necessidades.
